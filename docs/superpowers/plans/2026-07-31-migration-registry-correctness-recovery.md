...
- [x] **Step 3: Implement normalized registry scope**
...
- [x] **Step 1: Write failing claim and ordering tests**
...
- [x] **Step 3: Implement the atomic claim**
...
- [x] **Step 4: Update registry schema constraints**
...
- [x] **Step 6: Commit the claim behavior**
...
- [x] **Step 3: Implement explicit recovery**
...
- [x] **Step 4: Run helper and task regression tests**
...
- [x] **Step 1: Write the live integration test**
...
- [x] **Step 2: Run the live migration integration test**
...
- [x] **Step 3: Update migration documentation and task help**
...
- [x] Every public migration operation applies registry scope options.
- [x] Elixir and CLI option names map to the same behavior.
- [x] A second concurrent runner cannot send target SQL after losing the claim.
- [x] Files execute serially and the first failure stops the batch.
- [x] `running` remains blocking unless explicit recovery is enabled.
- [x] Separate-registry live integration coverage exists.
- [x] Documentation explains dependencies, crash states, and operator recovery.
