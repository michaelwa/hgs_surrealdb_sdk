...
**Status:** Complete. Implemented and verified on 2026-07-30.
...
- [x] **Step 1: Extend the fake socket with response overrides.**
...
- [x] **Step 2: Add the direct readiness regression test.**
...
- [x] **Step 3: Add failing direct error and timeout tests.**
...
- [x] **Step 4: Run the focused tests and confirm the new tests fail for the readiness gap.**
...
- [x] **Step 5: Commit the test harness and regression cases.**
...
- [x] **Step 1: Add a failing direct waiter test at the connection boundary.**
...
- [x] **Step 2: Replace `perform_setup/1` and `await_response/1` with non-blocking setup state.**
...
- [x] **Step 3: Enforce one deadline for all setup phases.**
...
- [x] **Step 4: Run setup unit tests and the existing WebSocket suite.**
...
- [x] **Step 5: Commit the setup state machine.**
...
- [x] **Step 1: Add process-cleanup assertions to direct failure tests.**
...
- [x] **Step 2: Wait for readiness in `SurrealDB.WebSocket.connect/2`.**
...
- [x] **Step 3: Remove direct-client setup polling from unit tests.**
...
- [x] **Step 4: Run the focused suite and formatting.**
...
- [x] **Step 5: Commit direct-client synchronization.**
...
- [x] **Step 1: Add a reconnecting setup-pending regression test.**
...
- [x] **Step 2: Add reconnect timeout coverage.**
...
- [x] **Step 3: Verify setup failure handling for stores.**
...
- [x] **Step 4: Run store and WebSocket regression tests.**
...
- [x] **Step 5: Commit the store compatibility coverage.**
...
- [x] **Step 1: Remove `await_ws_ready/0` from integration support.**
...
- [x] **Step 2: Make the integration WebSocket test issue its first RPC immediately.**
...
- [x] **Step 3: Update transport documentation.**
...
- [x] **Step 4: Run integration-support checks without requiring Docker.**
...
- [x] **Step 5: Commit integration and documentation updates.**
...
- [x] **Step 1: Run formatting and warnings-as-errors compilation.**
...
- [x] **Step 5: Record verification results for handoff.**
